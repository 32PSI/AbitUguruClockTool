...
void setup() {
  ...
  mem.second[0]=0b00000000; //Clock panel 1st digit//ul,mid,dl,turbo,3,2,1,User
  mem.second[1]=0b00000000; //Clock panel 2nd digit//ul,mid,dl,Normal,prevU,PrevUR,PrevDR,PrevD
  mem.second[2]=0b00000000; //Clock panel 3st digit//ul,mid,dl,Quiet,prevU,PrevUR,PrevDR,PrevD
  mem.second[3]=0b00000000; //Clock panel 4st digit//ul,mid,dl,Default,prevU,PrevUR,PrevDR,PrevD
  mem.second[4]=0b00000000; //uper divider,mhz,half circle ul,VGA,prevU,PrevUR,PrevDR,PrevD
  mem.second[5]=0b00000000; //UR circle divider,divider line right,DR circle divider,divider line bottom,mid logo,AutoDrive,dividing line left,DL divider circle
  mem.second[6]=0b00000000; //UR temp 1st digit //u,ur,dr,d,ul,m,dl,CPU 
  mem.second[7]=0b00000000; //UR temp 2nd digit //u,ur,dr,d,ul,m,dl,SYS 
  mem.second[8]=0b00000000; //UR temp 3rd digit //u,ur,dr,d,ul,m,dl,decimal point 
  mem.second[9]=0b00000000; //C and some warning TR
  mem.second[10]=0b00000000;//fourth digit downtop right
  mem.second[11]=0b00000000;//third digit downtop right
  mem.second[12]=0b00000000;//second digit downtop right
  mem.second[13]=0b00000000;//first digit downtop right
